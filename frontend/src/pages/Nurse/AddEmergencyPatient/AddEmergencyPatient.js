...
import "./AddEmergencyPatient.css";
...
const AddEmergencyPatientForm = lazy(() =>
  import(
    "../../../components/Nurse/AddEmergencyPatientForm/AddEmergencyPatientForm"
  )
);

export default function AddEmergencyPatient() {
      ...
      {responseGetAllPatients.isLoading ? (
        ...
        <div className='superadmin-main flex flex-row w-full h-screen'>
          <div className='superadmin-main-left w-[20%] shadow-lg'>
            <SideNav
              activePage={`${browserLinks.nurse.category}/${browserLinks.nurse.internalPages.addEmergencyPatient}`}
            />
          </div>
